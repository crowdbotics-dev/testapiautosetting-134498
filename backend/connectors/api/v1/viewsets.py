...
class Testconnectors134498ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134498_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134498_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134498"
